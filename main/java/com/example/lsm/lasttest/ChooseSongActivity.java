...
import android.text.*;
import com.example.lsm.lasttest.helper.FileUri;

import static android.support.v4.content.PermissionChecker.checkSelfPermission;
//import static com.example.lsm.lasttest.ScanMidiFiles.hasPermissions;
...
class ScanMidiFiles extends AsyncTask<Integer, Integer, ArrayList<FileUri> > {
    ...
    /*
    android 6.0 permisson check and get the permisson
     */
