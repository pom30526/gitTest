...
import com.example.lsm.lasttest.core.model.*;
import com.example.lsm.lasttest.helper.ListInt;
import com.example.lsm.lasttest.midi.model.*;
...
public class SheetMusic extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public static final int LineSpace  = 8;   /** The space between lines in the staff */
    ...
    public static final int PageHeight = 500;  /** The height of each page (when printing) */
