...
public class SheetMusicActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle state) {
       ...
       // for (MidiTrack track : tracks) {
            for (int i = 0; i < midifile.tracks.size(); i++) {
                ...
                Log.d("ssss", midifile.tracks.get(i) + "/");
               Log.d("abcd",midifile.tracks.get(i).getNotes()+"");
             //   Log.d("pom200",midi.getDuration()+"");
     //       }
        }
    ...
    void createView() {
        ...
        player = new MidiPlayer(this, mHandler);
