...
import android.view.*;
import com.example.lsm.lasttest.MidiPlayer;
import com.example.lsm.lasttest.midi.model.MidiFile;
import com.example.lsm.lasttest.midi.model.MidiNote;
import com.example.lsm.lasttest.midi.model.MidiOptions;
import com.example.lsm.lasttest.midi.model.MidiTrack;
...
public class Piano extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public static final int MaxOctave = 7;  //default value =8 ,
    ...
    public Piano(Context context) {
        ...
        gray1 = Color.rgb(16, 16, 16);  //완전검정
        gray2 = Color.rgb(90, 90, 90);  //조금회색
        gray3 = Color.rgb(200, 200, 200); //완전 회색
        shade1 = Color.rgb(210, 205, 220);

        //shade2 = Color.rgb(150, 200, 220);
        shade2=Color.rgb(197,231,179);
        showNoteLetters = MidiOptions.NoteNameLetter;  //default NoteNameNone
    ...
    public void onMeasure(int widthspec, int heightspec) {
        ...
        margin = 0;
        BlackBorder = 0;//default WhitekeyWidth/2
