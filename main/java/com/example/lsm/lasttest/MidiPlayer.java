...
import com.example.lsm.lasttest.midi.model.MidiFileException;
...
public class MidiPlayer extends LinearLayout {
    ...
    static Bitmap Setting;         //내가 추가한 부분
    ...
    public static void LoadImages(Context context) {
        ...
        Setting      = BitmapFactory.decodeResource(res, R.drawable.setting);
    }
     ...
     */
    public MidiPlayer(Context context, Handler handler) {
        super(context);
        mHandler = handler;
        LoadImages(context);
    ...
    void CreateButtons() {
       // this.setOrientation(LinearLayout.HORIZONTAL);
        ...
        SettingButton.setImageBitmap(Setting);
        SettingButton.setScaleType(ImageView.ScaleType.FIT_XY);
        SettingButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Message message=mHandler.obtainMessage(set);
                mHandler.sendMessage(message);


            }
        });
        this.addView(SettingButton);
